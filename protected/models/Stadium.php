...
class Stadium extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('stadiumName', 'required'),
			array('stadiumName', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('stadiumId, stadiumName', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('stadiumId',$this->stadiumId,true);
		$criteria->compare('stadiumName',$this->stadiumName,true);
