 ...
 * @property string $leagueShortName
 */
class League extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('leagueName, leagueShortName', 'required'),
			array('leagueName', 'length', 'max'=>50),
			array('leagueShortName', 'length', 'max'=>5),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('leagueId, leagueName, leagueShortName', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('leagueShortName',$this->leagueShortName,true);
